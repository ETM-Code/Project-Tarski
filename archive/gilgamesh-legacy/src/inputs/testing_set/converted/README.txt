This folder contains converted testing data.

Files:
- test_7x7.csv : CSV with header "label,p00,p01,...,p66", values are u8 in 0..255
- test_7x7.bin : Binary with header + interleaved pixels and labels as described below
