...
/**
 * WARNING: This is a header file containing all model weights.
 * It should not be included anywhere other than model.cpp.
**/
 ...
 * Test accuracy: 86.91% (integer-only: 86.92%)
**/
...
#define FC1_OUTPUT_SHIFT (1)
#define FC2_WEIGHT_SHIFT (-8)
#define FC2_BIAS_SHIFT (-6)
...
#define FC1_REQUANT_SHIFT (-9)  /* acc_shift - out_shift */
#define FC1_BIAS_ALIGN_SHIFT (-1)  /* bias_shift - acc_shift */
#define FC2_REQUANT_SHIFT (-6)  /* acc_shift - out_shift */
#define FC2_BIAS_ALIGN_SHIFT (1)  /* bias_shift - acc_shift */
