...
|-------|---------------|-----------------|----------------|------------|
| StandardANN_Int8 | 88.44% | 87.80% | 88.37% | 574 |
| StandardANN_Int4 | 77.63% | 75.54% | 74.56% | 574 |
| GilgameshSNN_Int8 | 89.54% | 88.48% | 89.26% | 574 |
| GilgameshSNN_Int4 | 76.17% | 73.01% | 74.13% | 574 |
...
- `StandardANN_Int8_weights.pt`: PyTorch state dict
- `StandardANN_Int8_weights.json`: Weights exported as JSON (for gilgamesh compatibility)
- `StandardANN_Int4_weights.pt`: PyTorch state dict
- `StandardANN_Int4_weights.json`: Weights exported as JSON (for gilgamesh compatibility)
- `GilgameshSNN_Int8_weights.pt`: PyTorch state dict
- `GilgameshSNN_Int8_weights.json`: Weights exported as JSON (for gilgamesh compatibility)
- `GilgameshSNN_Int4_weights.pt`: PyTorch state dict
- `GilgameshSNN_Int4_weights.json`: Weights exported as JSON (for gilgamesh compatibility)
